        ...
        <div id="mainContent" class="container-fluid">
            <div>
                <div id="right-bot-container">
                    ...
                    <ul>
                        <li>
                            <form target="_self" action="inspectionTransition/finalSubmition.php" method="post">
                                <!-- the actual generation of questions are outsourced to a php -->
                                <p>Are you sure to submit?</p>

                                <input type="button" onclick="location.href='inspection_form3.php';" value="No" name="btn_no">
                                <input type="submit" value="Yes" name="btn_yes">
                            </form>
                        </li>
                    </ul>
