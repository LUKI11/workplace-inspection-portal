...
<head>
	...
	<div id ="main">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-10" style="">
                        ...
                        </a><img src="images/report.png" height="40">
					</div>
                    <div class="col-md-2">
                        Welcome,&nbsp;
		...
		<div id="right-bot-container">
			  <a href="report.php"><div class = "Create_button2" >
				Back
			</div></a>
	  		<div id = "cap_sample">
				<object data="sam.pdf" type="application/pdf" width="1150px" height="600px">
      				  alt : <a href="sam">sam.pdf</a>
   				 </object>
	  		</div>
		</div>
	</div>
