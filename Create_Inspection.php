<?php include("conn/createInspForm.php")?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div id="mainContent" class="container-fluid">
            <div>
                <div id="right-bot-container">
                    ...
                    <ul>
                        <li>
                            <form target="_self" action="conn/submitInspForm.php" method="post">
                                <!-- the actual generation of questions are outsourced to a php -->
                                <?php include('inspectionTransition/genQuestions3.php') ?>

                                <input type="submit" value="Next Page" name="SubmitButton">
